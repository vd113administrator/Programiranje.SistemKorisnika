...
/**
 * Grupa metoda za provjeru autorizacije 
 * @author Mikec
 */
public class AutorizacijaControl {
    ...
    /**
     * Provjera autorizacije na nepostojanje podataka
     * @param ap  autorizacioni podaci
     * @return rezultat provjere i poruka
     */
     ...
     /**
      * Provjera autorizaconih podataka gdje se provjerava sifra po hes vrijednosti 
      * @param ap autorizacioni podaci
      * @return rezultat provjere i poruka
      */
